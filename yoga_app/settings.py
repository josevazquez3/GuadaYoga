...
EMAIL_HOST_PASSWORD = 'fcdtjxtbeyksvxva'  # SIN espacios
...
ACCOUNT_EMAIL_SUBJECT_PREFIX = '[Yoga App] '
...
ACCOUNT_EMAIL_CONFIRMATION_SEND_EMAIL = True
...
# Custom settings for account activation
...
# Custom allauth settings for handling existing email signup
